...
class QgisInterface(QObject):
    ...
    def __init__(self, canvas):
        ...
        proj.read("/Users/alan/Desktop/Speckle QGIS Projects/Speckle.qgz")
        proj.layersAdded.connect(self.addLayers)
        # noinspection PyArgumentList
        proj.instance().layerWasAdded.connect(self.addLayer)
        # noinspection PyArgumentList
        proj.instance().removeAll.connect(self.removeAllLayers)
